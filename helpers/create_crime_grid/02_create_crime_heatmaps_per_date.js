...
function filter_crime_data(country, date, crime_category){
  ...
  var WriteStream = require('../streams/file_writable_stream.js'),
      crime_category_heatmap = WriteStream(path.resolve('../create_crime_grid/json/'+country+'/dates/'+date+'/selected_crimes', crime_category+'_heatmap.json'));
...
filter_crime_data('uk', '2016-04', 'anti-social-behaviour');
